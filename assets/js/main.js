jQuery(document).ready(function($) {
    ...
    function initPreLoader() {
        ...
        setTimeout(function() {
            $("body").find('.animationSvg svg path').each(function() {
                $(this).css({
    ...
    $(".footer__menu .menu-item a").each(function(index) {
        var cont = $(this).text();
        $(this).attr("data-overtext", cont);
    });
    $(".footer__info a").each(function(index) {

        var cont = $(this).text();
        $(this).attr("data-txt", cont);
    });
    ...
    function showBlock() {
        var portfolio__block = $('.portfolio-item')
    ...
    $(".wp-block-image a").fancybox().attr('data-fancybox', 'gallery');

    $(".services-accordion__block").click(function() {
        $(this).toggleClass("is--open");
    })
    $('.form__group input').focusin(
        function() {
            $(this).closest(".form__group").addClass('is--focus');
        }).focusout(
        function() {
            $(this).closest(".form__group").removeClass('is--focus');
        });
